...
if __name__ == "__main__":
    ...
    data_ext = "_resize.mixed10"
    label_ext = "_resize.desmap"
    #file_dir = "../data/cam253/[cam253]-2016_4_21_15h_150f/"
    file_dir = "../data/Cam253/"
    video_list = file_io.get_listfile(file_dir, ".avi")
    ...
    train_file_list_name = 'train_list2.txt'
    file_io.save_file(train_list, file_list_dir + train_file_list_name, True)

    test_file_list_name = 'test_list2.txt'
